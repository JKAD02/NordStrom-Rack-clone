      ...
      <div className='box-2'>
        <div className='subbox-1-box-2'>
          <p className='workout_title'>
            <strong>The Best Mother’s Day Gifts for 2022</strong>
          </p>
          <img
            src='https://n.nordstrommedia.com/id/83ae8a49-2bec-475b-8ff9-89102434a25b.jpeg?h=519&w=1334'
            className='show_img'
          />

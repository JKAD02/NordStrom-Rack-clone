    ...
    return(
        <div className='main_div'>
            ...
            <div className='shopping_bag_main1'>
                ...
                <p className='shopping_bag_main1_sub2'>Items in your bag are not on hold.</p>
                <p className='shopping_bag_main1_sub2'><img src={giflogo} />  Add a gift message when you check out.</p>
            </div>
             ...
             <div className='buying_product' key={item.id}>
                 ...
                 <div className='buying_product_info'>
                     <div className='buying_product_info1'>
                      ...
                      <p className='buying_product_info_quantity'>Quantity: {item.quantity}</p>
                      <p className='buying_product_info_price'>Price: ${item.price}</p>
                ...
                <div className='buying_product_info2'>
                    <div className='buying_product_info2_sub'>
                     <button className='buying_product_info2_sub_qty'
                     onClick={()=>updateItemQuantity(item.id,item.quantity+1)} >+</button>
                     <button className='buying_product_info2_sub_qty'
                     onClick={()=>updateItemQuantity(item.id,item.quantity-1)} >-</button>
                     <button className='buying_product_info2_sub_remove'

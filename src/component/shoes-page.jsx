...
const name=["Boots","Sneakers","Loafers & Slip-Ons","Dress Shoes","Active & Running"]
const type=["Men'sShoes","Athletic","Running","BoatShoes","Boots","Comfort","Sneakers","Sandals","WhiteSneakers","Socks","YoungAdult","SandalsUnder$25","WhiteSneakers","Hoodies","Rashguards","Tanks","Activewear","T-Shirts","Underwear","Pajamas","Sets"]
...
export const Shoes_Page=()=>{
    ...
    useEffect(() => {
        const sortArray = type => {
          ...
          const sorted = [...Shoesdata].sort((a, b) => b[sortProperty] - a[sortProperty]);
          setData(sorted);
        };
        sortArray(sortType);
      }, [sortType]); 
        ...
        <div className="container">
            ...
            <div className='box-2'>
                <div className='subbox-1-box-2'>
                    ...
                    <img src="https://n.nordstrommedia.com/id/39ed6b0b-e07e-43ee-af1b-3fd7deb702ce.jpeg?h=417&w=1334" className='show_img'/> 
